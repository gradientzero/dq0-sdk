...
privacy_level = 2
connection = '../dq0-sdk/dq0/examples/newsgroups/_data/20newsgroups_text_label_df.csv'
...
with open(os.path.join(os.path.split(connection)[0], '20newsgroups_text_label_df_generated_full.yaml'), 'w') as f:
    yaml.dump(meta_d, f)
