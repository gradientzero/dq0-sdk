...
class DefaultDatabase:
    ...
    def mergeDefaultAttributesWith(database_attributes_list):
        ...
        return Attribute.merge_many(list_a=default_database_attributes_list, list_b=database_attributes_list, overwrite=True) if database_attributes_list is not None else default_database_attributes_list
