...
class ColumnFloat:
    ...
    def json_schema():
        return JsonSchemaNode.json_schema(
            ...
            attributes_groups=[
                JsonSchemaColumn.data(data_type_name=AttributeType.TYPE_NAME_FLOAT),
                JsonSchemaAttributesGroup.private_sql(
                    attributes=[
                        JsonSchemaAttribute.no_key_list(
                            ...
                            item_type_name=AttributeType.TYPE_NAME_FLOAT
                        ),
                ...
                JsonSchemaAttributesGroup.private_synthesis(
                    attributes=[
                        JsonSchemaAttribute.json_schema(
                            key='discrete',
                            attribute_name='discrete',
                            description=f"The 'discrete' attribute. Specifies whether this '{NodeType.TYPE_NAME_COLUMN}' is discrete.",
                            type_name=AttributeType.TYPE_NAME_BOOLEAN
                        ),
                        JsonSchemaAttribute.json_schema(
                            key='min_step',
