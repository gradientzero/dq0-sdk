...
class ResultProcessorClassicDP:
    @staticmethod
    def verify(attribute, role_uuids=None):
        ...
        ResultProcessorClassicDP.verify_attributes(attributes=attribute.get_value(), role_uuids=role_uuids)
    ...
    def verify_attributes(attributes, role_uuids=None):
        ...
        if type_name_attributes[0].get_value() != 'classic_dp':
            raise Exception(f"result processor type_name value {type_name_attributes[0].get_value()} does not match 'classic_dp'")
        ...
        return JsonSchemaRunAttributesGroup.result_processor(
            attributes=[
                JsonSchemaRunAttribute.processor_type_name(
                    ...
                    additional_value="\"const\": \"classic_dp\""
                ),
