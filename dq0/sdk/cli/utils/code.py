...
from dq0.sdk.errors import DQ0SDKError
...
def replace_model_parent_class(lines, parent_class_name):  # noqa: C901
    ...
    for line in lines:
        try:
            index = line.index('from dq0.sdk.models')
            if index == 0:
                if parent_class_name == 'NeuralNetwork':
                    line = 'from dq0.sdk.models.tf.neural_network import NeuralNetwork\n'
                elif parent_class_name == 'NeuralNetworkClassification':
                    line = 'from dq0.sdk.models.tf.neural_network_classification import NeuralNetworkClassification\n'
                elif parent_class_name == 'NeuralNetworkMultiClassClassification':
                    line = 'from dq0.sdk.models.tf.neural_network_multiclass_classification import NeuralNetworkMultiClassClassification\n'
                elif parent_class_name == 'NeuralNetworkRegression':
                    line = 'from dq0.sdk.models.tf.neural_network_regression import NeuralNetworkRegression\n'
                elif parent_class_name == 'NeuralNetworkYaml':
                    line = 'from dq0.sdk.models.tf.neural_network_yaml import NeuralNetworkYaml\n'
        except ValueError:
            pass
        try:
