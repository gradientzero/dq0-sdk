...
type_ = 'CSV'
connection = '/Users/cl/Documents/projects/dq0-sdk/dq0/sdk/examples/census/_data/adult_processed.csv'
...
with open(os.path.join(os.path.split(connection)[0],'metadata_preprocessed.yaml'), 'w') as f:
    yaml.dump(meta_d, f)
meta_dq0.to_yaml_file(os.path.join(os.path.split(connection)[0],'metadata_parsed_preprocessed.yaml'))
