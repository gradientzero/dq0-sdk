...
test_case = 'Census'  # 'Cifar_10' '20_Newsgroups', '20_Newsgroups_Bayesian',
# 'Census'
...
elif test_case.lower() == '20_Newsgroups_Bayesian'.lower():
    UserModel = getattr(importlib.import_module('dq0sdk.examples.newsgroups.model.bayesian_user_model'), 'UserModel')
